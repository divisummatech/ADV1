...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [a set of fuit as name of it]
        ...
        //2b. What will this output? [an updated set after add new fruit names]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
        ...
        for (Integer number : numbers) {
            if (number > max) { // Update max if number is greater
                max = number;
            }
            if (number < min) { // Update min if number is smaller
                min = number;
            }
        }
        ...
        for (Integer itemA : setA) {
            if (setB.contains(itemA)) { // Check if itemA is also in setB
                itemsContainedInBothSets.add(itemA); // Add itemA to itemsContainedInBothSets if it is in setB
            }
        }
